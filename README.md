...
Macros to analyze flat ntuples such as NANOAOD ntuples, L1 ntuples or private ntuples (specifically for NANOAODv15). 
## Quick Start
- Clone the repo:
  ```
...
Go to specific subdirectories for more information.# MacrosNtuples
